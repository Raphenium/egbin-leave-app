		...
		<div class="col-md-offset-2 col-md-8">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading">
					...
					<h4>Create Exam Leave</h4>

				</div>

				<div class="panel-body">
					<sf:form class="form-horizontal" modelAttribute="product" action="${contextRoot}/manageStaff/${3}/update" method="POST">
						

						<div class="form-group">
							<label class="control-label col-md-4">Number of Days Applied</label>
							<div class="col-md-8">
