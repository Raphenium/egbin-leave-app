...
resumption_date DATE,   
	days INT,
annual_leave_applied INT,
sick_leave_applied INT,
exam_leave_applied INT,
status VARCHAR(20),
user_id INT,
	CONSTRAINT pk_leave_id PRIMARY KEY (id),
	CONSTRAINT fk_leave_user_id FOREIGN KEY (user_id) REFERENCES user_detail (id)
);
...
manager_id INT,
	CONSTRAINT pk_leave_id PRIMARY KEY (id),
	CONSTRAINT fk_leave_user_id FOREIGN KEY (user_id) REFERENCES user_detail (id),
CONSTRAINT fk_leave_staff_id FOREIGN KEY (manager_id) REFERENCES staffrecord (id)
);
